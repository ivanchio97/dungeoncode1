...
const MediumCode = ({show,setShow}) =>{
  ...
  const [comparador, setComparador] = useState(Math.floor(Math.random()*100)+5)
  ...
  return (
    <div className='code'>
      ...
      <div><p></p><p></p><p></p> <p></p><p></p><p></p>{"   print(total)"}</div>
